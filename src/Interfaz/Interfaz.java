...
public class Interfaz extends JFrame {
	...
	public Interfaz() {
		...
		//Definicion de  textos de la interfaz
		...
		//definicion del campo de resultado
		labelResultado = new JLabel("resultado");
		labelResultado.setBounds(361, 122, 229, 14);
		contentPane.add(labelResultado);
		

		//definicion del boton de consulta por codigo
		...
		//definicion del texto adyacente al campo para el codigo de consulta
		...
		//definicion del boton de borrado
		...
		btnNewButton.setBounds(23, 240, 177, 23);
		contentPane.add(btnNewButton);

		
		//definicion del boton de Modificacion
		...
		btnNewButton_1.setBounds(23, 270, 179, 23);
